    ...
    >
      <div className="flex items-center gap-3 rounded-2xl border border-slate-100 bg-white px-4 py-3 shadow-[0_16px_50px_rgba(15,23,42,0.08)]">
        <div className="relative size-9">
          ...
          <div className="absolute inset-0 animate-spin rounded-full border-2 border-transparent border-t-[#0088FF]" />
          <div className="absolute inset-[9px] rounded-full bg-[#0088FF]/10" />
        </div>
        <div>
